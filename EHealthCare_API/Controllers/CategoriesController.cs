...
namespace EHealthCare_API.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        public CategoriesController(MedicineStoreDbContext context)
        {
            _context = context;
        }
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Category>> GetCatgories(int id)
        {
        ...
        public async Task<ActionResult<Category>> PostCategories(Category category)
        {
            ...
            return CreatedAtAction("GetCategories", new { id = _context.Categories.Max(m => m.ID) }, category);
        }
